...
The above result is the output of __Stage 2 {META EXTRACTION}__ which takes around __56 seconds to process 19 excel files of 1.1 GB__.This time varies between __50 to 60 seconds__ depending upon the current load on the system.
